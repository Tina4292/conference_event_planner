...
import { useSelector, useDispatch } from "react-redux"; //Required dependency
import { incrementQuantity, decrementQuantity } from "./venueSlice"; //Required dependency
...
const ConferenceEvent = () => {
    ...
    const handleAddToCart = (index) => { //this is an event handler that manages the increase quantity from the user interactions
